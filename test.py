...
def manual_change_function():
    x = subprocess.check_output("cat configuration_and_log/a1 | grep -v '#' | sed '/^$/d;s/[[:blank:]]//g' > configuration_and_log/configuration1.txt", shell=True)
...
def sample_function():
    print('''Press 1 for connectivity among themselves
Press 2 for siteminder
Press 3 for Broadsoft
Press 4 for DB
press 5 for all''')
    a = int(input())

    if (a==1):
        x1 = subprocess.check_output("cp configuration_and_log/configuration_manual_change.txt configuration_and_log/a1", shell=True)
        x2 = subprocess.check_output("sed 's/Siteminder/#Siteminder/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x3 = subprocess.check_output("sed 's/Broadsoft/#Broadsoft/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x4 = subprocess.check_output("sed 's/DB_Server/#DB_Server/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        manual_change_function()
        x5 = subprocess.check_output("rm -rf configuration_and_log/a1", shell=True)

    elif (a==2):
        x1 = subprocess.check_output("cp configuration_and_log/configuration_manual_change.txt configuration_and_log/a1", shell=True)
        x2 = subprocess.check_output("sed 's/Verify/#Verify/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x3 = subprocess.check_output("sed 's/Broadsoft/#Broadsoft/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x4 = subprocess.check_output("sed 's/DB_Server/#DB_Server/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        manual_change_function()
        x5 = subprocess.check_output("rm -rf configuration_and_log/a1", shell=True)
        ...
        x1 = subprocess.check_output("cp configuration_and_log/configuration_manual_change.txt  configuration_and_log/a1", shell=True)
        x2 = subprocess.check_output("sed 's/Verify/#Verify/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x3 = subprocess.check_output("sed 's/Siteminder/#Siteminder/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x4 = subprocess.check_output("sed 's/DB_Server/#DB_Server/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        manual_change_function()
        x5 = subprocess.check_output("rm -rf configuration_and_log/a1", shell=True)
        ...
        x2 = subprocess.check_output("sed 's/Verify/#Verify/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x3 = subprocess.check_output("sed 's/Broadsoft/#Broadsoft/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        x4 = subprocess.check_output("sed 's/Siteminder/#Siteminder/g' configuration_and_log/a1 > a && mv a configuration_and_log/a1", shell=True)
        manual_change_function()
        x5 = subprocess.check_output("rm -rf configuration_and_log/a1", shell=True)
